  ...
  return (
    <div className="absolute left-[-120px] flex justify-between  items-center w-11/12 h-1/2 ">
      ...
      <div className="w-[600px] flex flex-col">
        <h1 className="leading-none font-bold text-[60px] uppercase">
          {props.title}
        </h1>
        <p className="text-[27px] mt-5">{props.content}</p>
        {props.joinButton && (
          <button className="mt-10 w-[146px] h-[49px] bg-black rounded-[9px] text-white font-semibold uppercase text-[25px] py-2 px-4">
            Join Us
          </button>
        )}
      </div>
