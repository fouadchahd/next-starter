...
const Services: NextPage = () => {
  return (
    <>
      ...
      <div className="h-screen scrollbar-hide overflow-x-hidden overflow-y-visible w-screen bg-gray-100 bg-digit-background">
        ...
        >
          <AboutContent
            ...
            image={""}
            content={
              "Ranging from a simple static website, to a CMS to a more complex web application, at BITS, we can deliver what you need using the correct (sometimes latest isnt the best) technologies for the project."
            }
          />
        ...
        <div
          id="Sec3"
          className="relative flex  items-center h-screen w-screen bg-violet-300-300"
        >
          <AboutContent
